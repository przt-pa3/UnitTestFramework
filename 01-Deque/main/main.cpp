...
void RegisterTests()
{
	...
	// ArrayDeque Test
	RegisterTest(module, ArrayDequeConstruction);
	RegisterTest(module, ArrayDequePushFront);
	RegisterTest(module, ArrayDequePushBack);
	RegisterTest(module, ArrayDequePushAndResize);
	RegisterTest(module, ArrayDequeRandomPushIndexing);
	RegisterTest(module, ArrayDequeRemoveFront);
	RegisterTest(module, ArrayDequeRemoveBack);
	RegisterTest(module, ArrayDequeRemoveInEmpty);
	RegisterTest(module, ArrayDequeEmpty);

	// ListDeque Test
	RegisterTest(module, ListDequeConstruction);
	RegisterTest(module, ListDequePushFront);
	RegisterTest(module, ListDequePushBack);
	RegisterTest(module, ListDequeRemoveFront);
	RegisterTest(module, ListDequeRemoveBack);
	RegisterTest(module, ListDequeIndexing);

	// Palindrome Test
	RegisterTest(module, PalindromeArrayDeque);
	RegisterTest(module, PalindromeListDeque);
}
